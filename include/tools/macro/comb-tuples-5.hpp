...
#define dTOOLS_MACRO_COMB_TUPLES_5_USED_ 1
...
//==============================================================================
    ...
    #define dCOMB_TUPLES_1(macro, delim, collect, a1) \
        dFOREACH_MAX_5(macro, delim, a1, dCOMB_TUPLES_EXPAND collect)

    #define dCOMB_TUPLES_2(macro, delim, collect, a1, a2) \
        dCOMB_TUPLES_1(macro, delim, collect, a1) \
        delim(1) dFOREACH_MAX_5(macro, delim, a2, dCOMB_TUPLES_EXPAND collect)

    #define dCOMB_TUPLES_3(macro, delim, collect, a1, a2, a3) \
        dCOMB_TUPLES_2(macro, delim, collect, a1, a2) \
        delim(2) dFOREACH_MAX_5(macro, delim, a3, dCOMB_TUPLES_EXPAND collect)

    #define dCOMB_TUPLES_4(macro, delim, collect, a1, a2, a3, a4) \
        dCOMB_TUPLES_3(macro, delim, collect, a1, a2, a3) \
        delim(3) dFOREACH_MAX_5(macro, delim, a4, dCOMB_TUPLES_EXPAND collect)

    #define dCOMB_TUPLES_5(macro, delim, collect, a1, a2, a3, a4, a5) \
        dCOMB_TUPLES_4(macro, delim, collect, a1, a2, a3, a4) \
        delim(4) dFOREACH_MAX_5(macro, delim, a5, dCOMB_TUPLES_EXPAND collect)

    #define dSTART_COMB_TUPLES_MAX_5(macro, delim, collect2, ...) \
        dMACRO_CHOOSER_5(dCOMB_TUPLES, __VA_ARGS__)(macro, delim, collect2, __VA_ARGS__)

    #define dCOMB_TUPLES_MAX_5(macro, delim, collect1, collect2) \
        dSTART_COMB_TUPLES_MAX_5(macro, delim, collect2, dCOMB_TUPLES_EXPAND collect1)
